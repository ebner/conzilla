 ...
 *  @version $Revision$
 */
public interface Neuron extends Component //, Group
{
   ...
   *
   *  @return the data values contained in this Neuron.
   */
  ...
  /** Adds an axon to this group(neuron) with this neuron as the axons 
   *  subject and with the same uri except an extra fragment identifying the axon.
   *
   *  @deprecated Should be replaced with <code>addAxon(Axon axon)</code>
   *
   *  @param typeuri the uri of the predicate (old axontype).
   *  @param objecturi the uri of the object (old otherend neuronuri).
   *  @exception ReadOnlyException if the Neuron was not editable.
   *  @exception NeuronException if the Axon could not be created.
   *  @exception InvalidURIException if the Neuron URI was not valid.
   */
  Axon     addAxon(String typeuri, String objecturi)
