...
public interface Neuron extends Component
{
  ...
  int DATAVALUE_ADDED            = FIRST_NEURON_EDIT_CONSTANT;
  int DATAVALUE_REMOVED          = FIRST_NEURON_EDIT_CONSTANT + 1;
  int AXON_ADDED                 = FIRST_NEURON_EDIT_CONSTANT + 2;
  int AXON_REMOVED               = FIRST_NEURON_EDIT_CONSTANT + 3;
  ...
  void      removeAxon(String id) throws ReadOnlyException, NeuronException;
  Axon      addAxon(String id, String type, String neuronURI) throws ReadOnlyException, NeuronException, InvalidURIException;
