...
class MetaDataTest
{
  public static void main(String[] argv)
	...
	Tracer.setLogLevel(Tracer.ALL);
      ...
      Tracer.debug("Title: " + MetaDataUtils.getLocalizedString(md, md.get_general_title()));

      Tracer.debug("URIs: " + Arrays.asList(MetaDataUtils.getLocations(md.get_technical_location())));
