...
public class Id
{
  public static void main(String[] argv)
	...
	Tracer.setLogLevel(Tracer.NONE);
      ...
      URI newURI = URIClassifier.parseURI(argv[1], parsedURI);
      
      printURI(newURI);

      Tracer.debug("Relative again:     " + parsedURI.makeRelative(newURI, false));
      Tracer.debug("Relative again(..): " + parsedURI.makeRelative(newURI, true));
    }

  public static void printURI(URI parsedURI)
    {
      Tracer.debug("------------------------------");
      Tracer.debug("URI: " + parsedURI.toString());
