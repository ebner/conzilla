 ...
 *  in a ConceptMap.
 */
public interface AxonStyle extends ObjectStyle
{
    int PATH_TYPE_STRAIGHT=0;
    int PATH_TYPE_QUAD=1;
    int PATH_TYPE_CURVE=2;
  ...
  /** Returns the subjet of this AxonStyle.
   *
   *  @return the NeuronStyle that is the end of this AxonStyle.
   */
  NeuronStyle getSubject();


  /** Returns the object of this AxonStyle.
   *
   *  @return the NeuronStyle that is the end of this AxonStyle.
   */
  NeuronStyle getObject();

  /** Returns the NeuronStyle that is the end of this AxonStyle.
   *  @deprecated use <code>getObjectStyle()</code> instead.
   *  @return the NeuronStyle that is the end of this AxonStyle.
  NeuronStyle getEnd();
   */
