...
public interface NeuronStyle
{
  ...
  /** Returns the ID of this NeuronStyle. This ID
  ...
  /** Returns the AxonStyles that this NeuronStyle is the end of.
   *
   *  @return the AxonStyles that this NeuronStyle is the end of. Never null.
   */
  AxonStyle[] getEndOfAxonStyles();
   ...
   *  @param end the NeuronStyle the AxonStyle will point to.
   */
  AxonStyle addAxonStyle(String axonID, NeuronStyle end)
