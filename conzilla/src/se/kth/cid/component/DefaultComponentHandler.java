...
public class DefaultComponentHandler implements ComponentHandler
{
   ...
   *
   *  @param type the MIME type the handler can handle.
  ...
  protected TypedURI[] extractUsableURIs(URI uri, StringBuffer errors)
      ...
      if(uri instanceof PathURN)
	{
	  ...
	  {
	      addLocation(uri, null, resultList, errors);

	      //FIXME: Hack for demo for andrej
	      addLocation(uri, MIMEType.RDF, resultList, errors);
	  }
