...
// Contract: no arrays may contain null elements or be of size == 0.
// In addition, LangStringType.langstring != null
// and          LangString.string         != null
// and          Location.string           != null
...
public interface MetaData
{
  ...
  int              get_technical_size();
  void             set_technical_size(int size);
