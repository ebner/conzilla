...
public class XmlMetaDataHandler extends XmlLoaderHelper
{
  ...
  public static void load(MetaData metaData, XmlElement root)
    throws ReadOnlyException, XmlStructureException
    {
      ...
      if(technical != null)
	{
	  ...
	  metaData.set_technical_size(maybeGetLong(technical, "size"));
  ...
  public static XmlElement buildXmlTree(MetaData metaData)
      ...
      if(co != null)
	{
      ...
      maybeAddLong(technical, "size", metaData.get_technical_size());
  ...
  static String maybeGetString(XmlElement root, String elname) throws XmlStructureException
    {
  ...
  static String[] maybeGetStrings(XmlElement root, String elname) throws XmlStructureException
    {
  ...
  static MetaData.Location[] maybeGetLocations(XmlElement root) throws XmlStructureException
    {
  ...
  static MetaData.LangString elToLangString(XmlElement el) throws XmlStructureException
    {
      if(el != null)
  ...
  static MetaData.LangString maybeGetLangString(XmlElement root, String elname) throws XmlStructureException
    {
      XmlElement el = maybeGetSubElement(root, elname);
      if(el != null)
  ...
  static MetaData.LangString[] maybeGetLangStrings(XmlElement root, String elname) throws XmlStructureException
    {
      XmlElement[] els = root.getSubElements(elname);
  ...
  static MetaData.LangString[] elToLangStrings(XmlElement root) throws XmlStructureException
    {
  ...
  static MetaData.LangStringType maybeGetLangStringType(XmlElement root, String elname) throws XmlStructureException
    {
      XmlElement el = maybeGetSubElement(root, elname);
  ...
  static MetaData.LangStringType[] maybeGetLangStringTypes(XmlElement root, String elname) throws XmlStructureException
    {
  ...
  static MetaData.DateType maybeGetDateType(XmlElement root, String elname) throws XmlStructureException
    {
      XmlElement el = maybeGetSubElement(root, elname);
  ...
  static int maybeGetInt(XmlElement root, String elname)  throws XmlStructureException
    {
      XmlElement el = maybeGetSubElement(root, elname);
      ...
      if(el != null)
	{
	  ...
	  if(value < 0)
	    throw new XmlStructureException(elname + "=\"" + intStr +
  ...
  static long maybeGetLong(XmlElement root, String elname)  throws XmlStructureException
    {
      XmlElement el = maybeGetSubElement(root, elname);
      ...
      if(el != null)
	{
	  ...
	  value = Long.parseLong(intStr, 10);
  ...
  static String elToEntity(XmlElement el)  throws XmlStructureException
    {
  ...
  static String maybeGetEntity(XmlElement root)  throws XmlStructureException
    {
  ...
  static String[] maybeGetEntities(XmlElement root)  throws XmlStructureException
    {
  ...
  static void maybeAddLong(XmlElement root, String elname, long value) throws XmlElementException
    {
      if(value >= 0)
	maybeAddString(root, elname, Long.toString(value));
    }
