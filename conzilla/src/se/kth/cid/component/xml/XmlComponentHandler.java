...
public interface XmlComponentHandler
{
   ...
   * @param origuri the URI the Component will have..
   * @param loadURI the URI used to load the Component..
   * @return the loaded component. Never null.
   * @exception ComponentException if anything goes wrong.
   */
  GenericComponent loadComponent(XmlElement root, URI origuri, URI loadURI)
   ...
   *  it could in principle be used to dump a CORBA component.
   *
   *  The given component must be of the right type.
   *
   *  @param comp the component to build a tree from.
   *  @return An XML tree for the component.
   *  @exception ComponentException if anything goes wrong.
   */ 
