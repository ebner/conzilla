...
public class ReifiedResourceComponent extends ResourceComponent implements Axon, Statement
{
    ...
    public ReifiedResourceComponent(TotalModel totalModel, ConzillaRDFModel model, Resource resource, URI uri)
    {
	super(totalModel, model, resource, uri);
	this.statement = totalModel.getTripleFromReification(resource);
    }
  ...
  public String objectURI()
    ...
    /** This function is deprecated, should use objectURI instead.
     */
  ...
  public String subjectURI()
    ...
    /** this function is deprecated, use subject instead.*/
    public Neuron getNeuron()
    {
	return totalModel.findComponent(subjectURI());
    }
