 ...
 *
 *  1. An element cannot have both CDATA and sub-elements.
...
public class XmlElement
{
  ...
  public void setCDATA(String ncdata)
    throws HasSubElementsException
    {
      if(elements.size() > 0)
	throw new HasSubElementsException(this);
   ...
   *
   *  This is not allowed if this element already has CDATA,
   *  or if the known sub-elements were specified in the constructor
   *  and this sub-element is not among them.
   *
   *  @param el the element to add.
   */
  public void addSubElement(XmlElement el)
    throws HasCDATAException, UnknownElementNameException
    {
      if(cdata != null)
	throw new HasCDATAException(this);
