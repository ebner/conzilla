...
public abstract class PopupHandler 
{
    ...
    public static final KeyStroke [] strokes = {KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_SPACE ,0),
    ...
    public static final String [] keys = {"Space",
					  "Up",
					  "Down",
					  "Expand",
					  //					  "Left",
