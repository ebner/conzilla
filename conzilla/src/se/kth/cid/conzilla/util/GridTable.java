...
public class GridTable extends JPanel
{
  ...
  public void update()
  {
    ...
    //This new Layout is deadly important....
    //If the old one is kept all old components
    //will have references in it and hence wont be
    //garbage-collected. If they then try to save themself
    //we are in big trouble. Can mainly happen in connection with
    //focusmanagment... for instance se bugfix in
    //se.kth.cid.conzilla.data.DataDisplayerComponent function removeRow.
    //FIXME Mikael: detta anser jag snarare vara en bugg i den komponenten...
    //              den ska inte göra något om man tagit loss den!
    //    setLayout(new GridBagLayout());
    components=new Vector();
