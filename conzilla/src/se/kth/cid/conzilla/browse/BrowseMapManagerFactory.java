 ...
 *  @version $Revision$
 */
public class BrowseMapManagerFactory extends MapManagerFactory
{
  ...
  public void install(MapController controller)
	...
	historyManager = controller.getLinearHistoryManager();
	
	suckIn = new SuckInTool(controller, controller.getMapPanel());
	browse = new Browse("Browse", controller);
  ...
  public void deInstall()
    {
	//Remove all menus from the ConzillaWindow.
	controller=null;
    }
