 ...
 *  @version $Revision$
 */
public class InfoMapTool extends MapTool
{

  public InfoMapTool(String name, MapController cont)
  {
  ...
  protected  void activateImpl()
    {
      if (mapObject!=null && mapObject.getNeuron()!=null)
	controller.getConzillaKit().getMetaDataDisplayer().showMetaData(mapObject.getNeuron());	
	else if (mapEvent.hitType==MapEvent.HIT_NONE)
	  controller.getConzillaKit().getMetaDataDisplayer().showMetaData(controller.getMapScrollPane().getDisplayer().getStoreManager().getConceptMap());
    }
}
