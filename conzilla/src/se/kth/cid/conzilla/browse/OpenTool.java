...
public class OpenTool extends AbstractTool
{
  ...
  protected void activateImpl()
	...
	omd=new OpenMapDialog(JOptionPane.getFrameForComponent(dialogParent),
			      controller.getCurrentMapManager().getDisplayer().getContentDescription().getURI().toString(),
			      controller);
      else
	omd.setURIText(controller.getCurrentMapManager().getDisplayer().getContentDescription().getURI().toString());
