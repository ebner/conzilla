...
{
  protected ContentDescription currentContent;
  ...
  public void setContent(ContentDescription c) throws ContentException
  {
    ContentDescription oldContent = currentContent;
    currentContent = c;
