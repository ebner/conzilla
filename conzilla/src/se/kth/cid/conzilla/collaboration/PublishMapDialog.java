...
public class PublishMapDialog extends JFrame {
    ...
    private void loadLocations() {
    	List locList = collabSupport.getLocations();
    ...
    private void initContributionMetaData() {
    	...
    	String agentURI = support.getAgentURI(support.getUserNamespace());
    	...
    	contributionModel = new ModelMem();
    ...
    private void initComponents() {
        ...
        LocationInformation prevInfo = collabSupport.getPreviouslyUsedDestination();
        if (prevInfo != null) {
        	...
        	publishButton.addActionListener(new ActionListener() {
        		public void actionPerformed(ActionEvent evt) {
        			if (otherDestRadioButton.isSelected()) {
        				collabSupport.storePreviouslyUsedDestination((LocationInformation)locationsModel.getSelectedItem());
        			}
        			publish();
        		}
        	});
    ...
    private void publish() {
		...
		new Thread(new Runnable() {
			public void run() {
				ContextMapPublisher publisher = new ContextMapPublisher(collabSupport, controller, contextMap,
	...
	public LocationInformation getLocationInformation() {
		if (previousDestRadioButton.isSelected()) {
			return collabSupport.getPreviouslyUsedDestination();
		} else {
