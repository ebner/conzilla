...
{
  boolean addNeuron(NeuronStyle ns);  
  boolean addNeuron(ContentDescription cd);
  boolean addNeuron(MapEvent m);
  ...
  boolean setCurrentNeuron(MapEvent m);
  boolean setCurrentNeuron(Neuron ne);
