...
{
  /** The type fired when a jump occurs.
   */
  public final static int JUMP    = 0;

  /** The type fired when a zoom in occurs.
   */
  public final static int ZOOMIN  = 1;

  /** The type fired when a zoom out occurs.
   */
  public final static int ZOOMOUT = 2;
  ...
  /** The URI of the destination (neuron or map).
   */
  URI destinationURI;

  /** The title of the destination (neuron or map).
   */
