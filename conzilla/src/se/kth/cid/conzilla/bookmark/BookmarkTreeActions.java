...
public class BookmarkTreeActions extends MouseAdapter implements KeyListener {
    ...
    protected static void openMap(String uriString, MapController controller) {
    	if (uriString != null) {
    		try {
	...
	protected static void openMapInNewView(String uriString, MapController controller) {
		if (uriString != null) {
    		try {
    			URI uri = new URI(uriString);
