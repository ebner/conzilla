 ...
 *  @version $Revision$
 */
public class PopupToolSetMenu extends JPopupMenu implements ToolStateListener
{
  /** Maps tool --> JMenuItem
   */
  Hashtable toolItems;
   ...
   */
  public PopupToolSetMenu(String title)
  {
    super(title);
   ...
   */
  public JMenuItem getToolItem(Tool tool)
    {
