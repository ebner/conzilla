...
public class AxonHideMapTool extends ActionMapMenuTool
{

  public AxonHideMapTool(MapController cont)
  {
    super("HIDE_AXON", EditMapManagerFactory.class.getName(), cont);
  }
