 ...
 *  @version $Revision$
 */
public class CreateContentMapTool extends MapTool
{

  public CreateContentMapTool(String name, MapController cont)
  {
  ...
  public void activateImpl()
      ...
      } catch (MalformedURIException me)
	{
      ...
      cEditor.editComponent(neuron, false);
      cEditor.editComponent(comp, ContentDialog.class, true);
    }
}
