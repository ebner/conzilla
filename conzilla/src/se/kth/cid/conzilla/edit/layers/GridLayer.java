...
public class GridLayer extends LayerComponent implements PropertyChangeListener
{
  ...
  public void activate(MapScrollPane pane)
    {
	GlobalConfig.getGlobalConfig().addPropertyChangeListener(EditMapManagerFactory.COLOR_GRID, this);	
  ...
  public void deactivate(MapScrollPane pane)
	...
	GlobalConfig.getGlobalConfig().removePropertyChangeListener(EditMapManagerFactory.COLOR_GRID, this);	
    }
  ...
  public void layerPaint(Graphics2D g, Graphics2D original)
	...
	if (gridModel.getGridStyle()==GridModel.STYLE_INVISIBLE || !gridModel.isGridOn())
	    return;
	g.setColor(GlobalConfig.getGlobalConfig().getColor(EditMapManagerFactory.COLOR_GRID));
