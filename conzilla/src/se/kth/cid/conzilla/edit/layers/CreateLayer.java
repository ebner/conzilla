...
//		ContextMap.Dimension dim = mapdisplayer.getStoreManager().getConceptMap().getDimension();
	...
	private void draw(MapEvent m) {
		...
		if (oldcurrent != null) {
			if (startPoint != null) {
				...
				Rectangle prect1 = HandledObject.positiveRectangle(rect1);
				repaint((int) (prect1.x * scale - 1), (int) (prect1.y * scale - 1), (int) (prect1.width * scale + 2), (int) (prect1.height
						* scale + 2));
			}
		...
		if (current != null) {
			if (startPoint != null) {
				...
				repaint((int) (prect2.x * scale - 1), (int) (prect2.y * scale - 1), (int) (prect2.width * scale + 2), (int) (prect2.height
						* scale + 2));
			}
	...
	public void layerPaint(Graphics2D g, Graphics2D original) {
		...
		if (current != null) {
			if (startPoint != null)
				g.drawLine((int) (startPoint.x * scale), (int) (startPoint.y * scale), (int) (current.mapX * scale),
						(int) (current.mapY * scale));
