 ...
 *  @version $Revision$
 */
public class AxonRemoveMapTool extends ActionMapMenuTool
{

  public AxonRemoveMapTool(MapController cont)
  {
    super("REMOVE_AXON", EditMapManagerFactory.class.getName(), cont);
  }
  ...
  public void actionPerformed(ActionEvent e)
    {
	  ...
	  !mapObject.getNeuronStyle().getBodyVisible())
	  {
		...
		{
		    mapObject.getNeuron().removeAxon(mapObject.getAxon().getURI());
