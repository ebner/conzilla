...
public class EditMapManagerFactory implements MapManagerFactory {
    public static final String PROJECTS_URI =
        "conzilla://ont/sessions.rdf";
...
//    public static final String COLOR_GRID = "conzilla.edit.grid.color";
    ...
    // FIXME replace occurrences of COLOR_* with Colors.*
    
    public static final String COLOR_CHOICES = Colors.FOREGROUND;
    
    public static final String COLOR_GRID = Colors.FOREGROUND;
