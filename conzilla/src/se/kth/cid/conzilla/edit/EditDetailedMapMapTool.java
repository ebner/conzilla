 ...
 *  @version $Revision$
 */
public class EditDetailedMapMapTool extends MapTool
{
  class DMDialog extends JDialog {
	...
	test.addActionListener(new ActionListener() {
	      ...
	      if(textField.getText().equals(""))
		{
	      ...
	      try {
		controller.getConzillaKit().getConzilla().openMap(textField.getURI());	
  ...
  public EditDetailedMapMapTool(String name, MapController cont)
    {
