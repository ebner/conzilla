...
public class EditMenu1 extends ToolMenu
{
    public EditMenu1(String name, MapController controller, AxonEdit axonEdit)
  {
    ...
    addTool(contentMenu);
    addTool(new DataVisibilityMapTool("DATA_VISIBILITY", controller));
    ...
    choice.addTool(new ViewAlterationTool("VIEW",controller));
    choice.addTool(new InfoMapTool("INFO",controller));
    choice.addTool(new StoreMapTool("COPY",controller));
  }    
}
