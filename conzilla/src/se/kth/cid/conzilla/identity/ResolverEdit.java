...
public class ResolverEdit extends JFrame
{
  ...
  public ResolverEdit(ResolverManager manager)
    {
	setTitle(ConzillaResourceManager.getDefaultManager().getString(ResolverExtra.class.getName(), "RESOLVER_EDIT"));
      ...
      for(int i = 0; i < resolverTables.length; i++)
	{
      ...
      ConzillaResourceManager.getDefaultManager().customizeButton(close, ResolverExtra.class.getName(), "CLOSE");
  ...
  void addTable(final int i)
      ...
      if(resolverTables[i].isSavable())
	{
	  ...
	  ConzillaResourceManager.getDefaultManager().customizeButton(add, ResolverExtra.class.getName(), "ADD");
	  ...
	  ConzillaResourceManager.getDefaultManager().customizeButton(remove, ResolverExtra.class.getName(), "REMOVE");
	  ...
	  ConzillaResourceManager.getDefaultManager().customizeButton(save, ResolverExtra.class.getName(), "SAVE");
	  ...
	  ConzillaResourceManager.getDefaultManager().customizeButton(restore, ResolverExtra.class.getName(), "RESTORE");
	...
	{
	  panel.add(new JLabel(ConzillaResourceManager.getDefaultManager().getString(ResolverExtra.class.getName(), "NOT_EDITABLE")), BorderLayout.SOUTH);
	}
      ...
      locPanel.add(new JLabel(ConzillaResourceManager.getDefaultManager().getString(ResolverExtra.class.getName(), "LOCATION") + ":  "), BorderLayout.WEST);
  ...
  void tryClose()
      ...
      for(int i = 0; i < tables.length; i++)
	{
	  ...
	  if(model.isEdited())
	    {
	      Object[] options = {
		  ConzillaResourceManager.getDefaultManager().getString(ResolverExtra.class.getName(), "SAVE_NOW"),
		  ConzillaResourceManager.getDefaultManager().getString(ResolverExtra.class.getName(), "DONT_SAVE"),
		  ConzillaResourceManager.getDefaultManager().getString(ResolverExtra.class.getName(), "CANCEL")};
	      int ret =
		JOptionPane.showOptionDialog(tables[i],
					     MessageFormat.format(ConzillaResourceManager.getDefaultManager().getString(ResolverExtra.class.getName(), "WARNING_TEXT"), new Object[] {resolverTables[i].getName()}),
					     ConzillaResourceManager.getDefaultManager().getString(ResolverExtra.class.getName(), "WARNING"), 
