...
public abstract class AbstractFilter implements Filter
{
  ...
  //    ContentSet cSet;
                          ...
                          throws FilterException
    {
      ...
      controller = cont;
      lifo = new Vector();
	//	Neuron neuron=cont.getConzillaKit().getComponentStore().getAndReferenceNeuron(filterURI);
      firstnode = new FilterNode(filterURI, cont.getConzillaKit().getComponentStore(), lifo, this);
    ...
    public void setContent(Component component)
    {
      contents = (new RelationSet(component, "content", 
				 controller.getConzillaKit().getComponentStore())).getRelations();
    }
