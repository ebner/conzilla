...
public interface FilterFactory
{
   ...
   *  @exception FilterException if the filter creation could not be performed.
   */
   ConcreteFilter createFilter(MapManager man, MapController cont, String filterURI) throws FilterException;
}
