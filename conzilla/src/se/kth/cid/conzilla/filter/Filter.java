...
public interface Filter
{
   ...
   *
   *  @param component the current Component to filter.
   */
   void setContent(Component component) throws ControllerException;
   ...
   *  @param component the Component whose content will be filtered.
   *  @return a vector with filtered content.
   Vector filterContent(FilterNode node, Component component);
   */
   
   boolean componentPasses(Component component, FilterNode node);
