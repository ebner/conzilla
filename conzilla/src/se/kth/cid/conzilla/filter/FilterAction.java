...
public class FilterAction extends AbstractAction {
  ...
  */
  public FilterAction(FilterNode node, String filtertag, MapManager manager)
  {
    super(filtertag);
    this.node = node;
  ...
  */
  public void setContent(Vector contents)
  {
    this.contents = contents;
  }

 /** Shows the content associated with this action given an ActionEvent.
  *
  *  @param parml the ActionEvent given by user.
  */
  public void actionPerformed(ActionEvent parm1) {
    manager.getFilter().showContent(contents);
  }
}