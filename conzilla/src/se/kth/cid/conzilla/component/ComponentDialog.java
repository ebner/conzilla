  ...
  implements EditListener, MetaDataEditListener
{
  ...
  public ComponentDialog(ConzillaKit kit)
    {
      ...
      menuManager.customizeButton(setButton, ComponentDialog.class.getName(), "SET");
      ...
      menuManager.customizeButton(saveButton, ComponentDialog.class.getName(), "SAVE");

      JButton copy = new JButton();
      copy.addActionListener(new ActionListener() {
	  public void actionPerformed(ActionEvent e) {
	    ClipboardLibrary cl = ComponentDialog.this.kit.getRootLibrary().getClipboardLibrary();
	    if (component != null)
	      cl.setComponent(component);
	  }});
      menuManager.customizeButton(copy, ComponentDialog.class.getName(), "COPY");
      
      String [] comboChoices={menuManager.getString(ComponentDialog.class.getName(), "METADATA"),
			      menuManager.getString(ComponentDialog.class.getName(), "COMPONENT")};
      ...
      customizeButtonBorderHeight(copy, 25);
      customizeButtonBorderHeight(setButton, 25);
      customizeButtonBorderHeight(saveButton, 25);
    ...
    void customizeButtonBorderHeight(JComponent comp, int size)
    {
  ...
  protected void createComponentTab()
    {	
      ...
      componentPanel.addPanel(ConzillaResourceManager.getDefaultManager().getString(ComponentDialog.class.getName(), "COMPONENT_URI"), componentURIField);
    }
