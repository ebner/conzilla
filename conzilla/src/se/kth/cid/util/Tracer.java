...
public class Tracer
{
  ...
  /** Programming error of some kind. Illegal arguments are included here.
   */
   ...
   */
  public final static int MAJOR_EXT_EVENT   = 4;

  /** Lesser, externally visible event (e.g. state change).
   */
  public final static int MINOR_EXT_EVENT   = 5;

  /** Larger, internally visible event (implementation dependent)
   */
  public final static int MAJOR_INT_EVENT   = 6;
  
  /** Lesser, internally visible event (implementation dependent)
   */
  public final static int MINOR_INT_EVENT   = 7;
   ...
   */
  public final static int DETAIL            = 8;
   ...
   */
  public final static int NONE              = DEBUG;
   ...
   */
  public final static String[] TRACESTR = {
    "DEBUG",
    "BUG",
    "ERROR",
    "WARNING",
