...
public class TripleHandlesStruct extends LineHandlesStruct {
	...
	/**
	 * The constructor loads and initializes DefaultHandles from the
	...
	public TripleHandlesStruct(StatementLayout as) {
		...
		if (points == null) {
			log.warn("A handledObject for a non visible triple is created, consequently no handles can be displayed! "
					+ "A HandledObject should ALWAYS be the effect of a selection via a mouse event.");
		}
