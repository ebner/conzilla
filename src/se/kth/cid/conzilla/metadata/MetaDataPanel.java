...
public class MetaDataPanel extends SinglePanelFormContainer {
    ...
    public void launchForm(Model model, Resource resource, boolean editable) {
        ...
        // VariableBindingSet.
        FormModel fModel = formlet.getFormModel().duplicate();
        fModel.setVariableBindingSet(variableBindingSet);
        fModel.setQueryTarget(queryTarget);
        form.create(fModel, null);
    }
}
