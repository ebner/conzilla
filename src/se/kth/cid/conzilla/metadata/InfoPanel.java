...
public class InfoPanel extends JPanel {
    ...
    public InfoPanel(se.kth.cid.component.Component component) {
        ...
        try {
            ...
            Container container = ConzillaKit.getDefaultKit().getResourceStore().getAndReferenceContainer(URI.create(containerString));
    ...
    private void initLayout() {
        ...
        metadataPanel = new MetaDataPanel(null, null, getBackground(), null);
