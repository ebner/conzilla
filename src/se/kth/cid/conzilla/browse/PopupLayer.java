 ...
 //   static Border inactiveBorder;
    ...
    void makeSubWin(MapEvent e) {
        ...
        try {
            ...
            activeSubMap.setScale(0.7 * controller.getView().getMapScrollPane().getDisplayer().getScale());
...
//        Point offset = controller.getView().getMapScrollPane().getDisplayer().getOriginLocation();
        Dimension d = comp.getPreferredSize(); 
        if (comp instanceof MapDisplayer) {
        	comp.setLocation(x, y);
            comp.setSize(d.width+5, d.height+5);
        } else {
