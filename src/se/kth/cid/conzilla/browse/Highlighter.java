...
//        reMarkAll();
    ...
    public void reMarkAll() {
        ...
        Mark overMarkSurf = new Mark(Colors.CONTEXT, null, null);
        Mark overMarkView = new Mark(Colors.CONTENT, null, null);
        Mark overMarkInfo = new Mark((String) null, null, null);        
        Mark overMarkSurfView = new Mark(Colors.CONTEXTANDCONTENT, null, null);
        Mark overMarkSurfInfo = new Mark(Colors.CONTEXT, null, null);
        Mark overMarkViewInfo = new Mark(Colors.CONTENT, null, null);
        Mark overMarkSurfViewInfo = new Mark(Colors.CONTEXTANDCONTENT, null, null);
