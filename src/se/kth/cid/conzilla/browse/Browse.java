...
public class Browse {
	...
	protected void setListeners() {
		...
		klickListener = new MapEventListener() {
			public void eventTriggered(final MapEvent e) {
				final MapScrollPane scroll = controller.getView().getMapScrollPane();
	...
	private void mark() {
		// The new mark
		Mark overMark = new Mark(Colors.CONCEPT_FOCUS, null,
				null);
...
//		popup.deactivate(pane);
	...
	public void markLastConcept(MapScrollPane pane, String uri) {
		...
		Mark lastMark = new Mark(Colors.CONCEPT_FOCUS, null, null);
