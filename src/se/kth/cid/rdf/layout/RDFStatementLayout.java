...
public class RDFStatementLayout
    ...
    protected RDFStatementLayout(URI uri, RDFConceptMap cMap, String statementURI, 
    		String subjectLayoutURI, String objectLayoutURI, Resource nodeType) {
    	super(uri, cMap, nodeType, statementURI);
    ...
    public RDFStatementLayout(URI uri, RDFConceptMap cMap, String statementURI, 
    	...
    	this(uri, cMap, statementURI, subjectLayoutURI, objectLayoutURI, CV.StatementLayout);
    }
