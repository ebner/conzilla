...
public class RDFDrawerLayout
    ...
    protected void removeFromModel(RDFModel model) {
        ...
        } catch (RDFException re) {} catch (InvalidURIException iue) {}
    }
    ...
    public void setDetailedMap(String uri, RDFModel model)
        ...
        try {
            ...
            if (detailedMap != null) {
                ...
                try { //Neccessary since getProperty throws exception if
                    // there isn't a statement at all..
        ...
        try {
            ...
            conceptMap.fireEditEvent(
                new EditEvent(
                    conceptMap,
                    this,
                    BOXLINEPATHTYPE_EDITED,
                    new Integer(boxLinePathType)));
